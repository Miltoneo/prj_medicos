...
urlpatterns = [
    ...
    path('lista_socios_empresa/<int:empresa_id>/socios/', views_socio.lista_socios_empresa, name='lista_socios_empresa'),
    path('socio_create/<int:empresa_id>/socios/novo/', views_socio.socio_create, name='socio_create'),
    path('socio_edit/<int:empresa_id>/socios/<int:socio_id>/editar/', views_socio.socio_edit, name='socio_edit'),
    path('socio_unlink/<int:empresa_id>/socios/<int:socio_id>/desvincular/', views_socio.socio_unlink, name='socio_unlink'),
