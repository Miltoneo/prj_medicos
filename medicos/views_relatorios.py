...
def relatorio_mensal_socio(request, empresa_id):
    ...
    relatorio = {
        ...
        'total_nf_valor_bruto': getattr(relatorio_obj, 'total_notas_bruto', 0),
        'total_nf_iss': getattr(relatorio_obj, 'total_iss', 0),
        'total_nf_pis': getattr(relatorio_obj, 'total_pis', 0),
        'total_nf_cofins': getattr(relatorio_obj, 'total_cofins', 0),
        'total_nf_irpj': getattr(relatorio_obj, 'total_irpj', 0),
        'total_nf_csll': getattr(relatorio_obj, 'total_csll', 0),
        'total_nf_valor_liquido': getattr(relatorio_obj, 'total_notas_liquido', 0),
