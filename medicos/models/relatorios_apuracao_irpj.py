...
class ApuracaoIRPJ(models.Model):
    ...
    adicional = models.DecimalField(max_digits=18, decimal_places=2, default=0)
    ...
    class Meta:
        ...
        verbose_name = 'Apuração IRPJ'
        verbose_name_plural = 'Apurações IRPJ'
        indexes = [
