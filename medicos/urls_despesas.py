...
urlpatterns = [
    ...
    path('empresa/<int:empresa_id>/<int:pk>/editar/', views_despesas.EditarDespesaEmpresaView.as_view(), name='editar_despesa_empresa'),
    path('empresa/<int:empresa_id>/<int:pk>/excluir/', views_despesas.ExcluirDespesaEmpresaView.as_view(), name='excluir_despesa_empresa'),
